    ...
    <div className='flex flex-col w-1/2 h-full justify-center items-center'>
        <form onSubmit={handleSubmit} className='w-3/5 h-1/2 flex flex-col items-start justify-around'>
            ...
            <div className='w-full'>
                <label class="block text-gray-700 text-xl font-extralight mb-2" for="username">
                  Username
                </label>
            ...
            <div className='w-full'>
                <label class="block text-gray-700 text-xl font-extralight mb-2" for="password">
                  Password
                </label>
            ...
            <button type='submit' className='w-full rounded-lg h-12 fondo-login text-white font-bold text-lg'>
                Create account
            </button>

            <button className='w-full flex flex-row justify-center items-center rounded-lg h-12 fondo-boton-google text-blue-500 font-bold text-lg'>
            ...
            <div className='text-lg w-full text-gray-400 flex flex-row justify-center'>
