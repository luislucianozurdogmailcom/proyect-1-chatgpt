...
const FileUpload = () => {
    ...
    <form className='w-90p h-1/4 m-auto my-10'>
        <div onDrop={handleFileDrop} onDragOver={event => event.preventDefault()} onDragEnter={event => event.preventDefault()} className='bg-gray-200 rounded-xl h-100 w-100 d-flex justify-content-center align-items-center flex-column'>
            ...
            <span className='text-lg mt-2 font-weight-bold'>
